...
//     string(name: 'ENTRY_FILE', defaultValue: 'run_flask.py', description: 'Streamlit entry file')
  ...
  stages {
    ...
    stage('Build image') {
      steps {
        ...
        sh '''
          set -e
          if docker buildx version >/devnull 2>&1; then export DOCKER_BUILDKIT=1; else export DOCKER_BUILDKIT=0; fi
